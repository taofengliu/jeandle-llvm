...
#ifndef LLVM_TRANSFORMS_JEANDLE_PARTIALESCAPEUTILS_H
#define LLVM_TRANSFORMS_JEANDLE_PARTIALESCAPEUTILS_H
...
// std::nullopt — a future hook into VMCallbacks will provide this (see
// PEA-Plan section 2.3.2).
...
// Algorithm: see PEA-Plan section 2.7.  Cycle-safe via a small visited set.
//
...
// non-constant index, inttoptr, or unrecognised pattern).  See PEA-Plan
// section 2.8.
