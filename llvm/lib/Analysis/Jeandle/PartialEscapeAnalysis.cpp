...
private:
  ...
  // inserts them). The placeholder is only a lock-cascade identity key per
  // (PH, TargetMerge, ID); the Materialize effect carries no per-pred fields
  // under reuse-OrigAlloc.
