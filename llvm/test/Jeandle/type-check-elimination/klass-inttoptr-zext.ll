; RUN: opt -S -passes="type-check-elimination" -jeandle-vm-callback-log=%S/Inputs/klass-inttoptr-zext.cblog %s 2>&1 | FileCheck %s

; Test: SuperKlass encoded as inttoptr(zext i32 to i64). extractKlassConstant
; should see through the zext instruction to extract the constant.
