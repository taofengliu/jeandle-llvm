...
; PEA-ON: {{.*jeandle-inline-driver,function\(java-op-length-folding,loop-simplify,loop\(loop-rotate.*indvars,loop-deletion\),loop-unroll<no-partial;no-runtime;no-upperbound;full-unroll-max=128;O3>,loop\(simple-loop-unswitch<nontrivial;trivial>\),instcombine.*gvn.*simplifycfg.*\),function\(adce\),function\(simplifycfg.*\),function\(loop-simplify\),function\(instcombine.*\),function\(partial-escape-iterative\),function\(instsimplify\),function\(recover-type-info\),function\(type-check-elimination\),function\(repeated-constant-field-folding\),function\(type-check-elimination\),function\(insert-gc-barriers\),java-operation-lower\<phase=1\>.*}}
...
; no PEA.
; PEA-OFF: {{.*jeandle-inline-driver,function\(instsimplify\),function\(recover-type-info\),function\(type-check-elimination\),function\(repeated-constant-field-folding\),function\(type-check-elimination\),function\(insert-gc-barriers\),java-operation-lower\<phase=1\>.*}}
