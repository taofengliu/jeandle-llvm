...
; (§8.1.15): memcpy with a virtual destination is not modelled by tier-2;
; it must conservatively force materialization. The memcpy intrinsic is a
; CallInst whose virtual operand triggers materializeAllVirtualOperands.
