...
; Unsafe.putInt-style decomposition. A virtual byte[] is written via a
; single i32 store at the array's base offset; PEA decomposes the i32
; value (0x1234ABCD = 305441741) into 4 byte FieldStates entries little-
; endian. Read-back of byte 2 (offset+2) returns 0x34 = 52.
...
n:
  ...
  ; Wide i32 store onto the byte array — decomposes into 4 i8 entries.
